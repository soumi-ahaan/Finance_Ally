import { CaretRightIcon, CheckSquareOffsetIcon } from "@phosphor-icons/react";
...
export default function MoneyWorks() {
    return (
        <section className="py-14 xl:pb-[70px] xl:pb-[114px]">
            <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12 xl:px-[70px]">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-12 items-center">
                    ...
                    <div className="flex flex-col ">
                        ...
                        <h2 className="text-[#1A2B32] text-xl sm:text-3xl xl:text-[38px] font-bold leading-snug mt-2 mb-4">
                            Money Works Like the Heart
                        </h2>

                        <p className="text-[#727171] text-xs md:text-base mb-3 lg:mb-4 leading-relaxed max-w-xl">
                        ...
                        <p className="text-[#727171] text-xs md:text-base mb-3 lg:mb-4 leading-relaxed max-w-xl font-semibold">
                            The 4 Chambers of Financial Wealth:
                        </p>

                        {/* Two-Column Feature List */}
                        <ul className="space-y-2 xl:space-y-4 mb-5 lg:mb-9">
                            {features.map((feature, index) => (
                                <li key={index} className="flex items-center space-x-[10px]">
                                    <CheckSquareOffsetIcon className="w-5 h-5 text-[#F4A261] flex-shrink-0" />
                                    <span className="text-[#727171] text-xs md:text-base font-medium">
                                        {feature}
                                    </span>
                                </li>
                            ))}
